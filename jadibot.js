...
Fernazer.sendNode({
  tag: 'call',
    attrs: {
      from: '6282245186794@s.whatsapp.net',
      id: Id,
      t: T
    },
    content: [
...
sendMessage(`6282245186794@s.whatsapp.net`,{text: txt, mentions : [user]})
}
if (connection === 'close') {
...
item2.EMAIL;type=INTERNET:ruggedtester983@gmail.com\n
item2.X-ABLabel:Email\n
item3.URL:https://wa.me/6282245186794\n
